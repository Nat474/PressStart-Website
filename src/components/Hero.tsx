...
const Hero = () => {
  ...
  const handleImageClick = () => {
    ...
    setTimeout(() => {
      ...
      window.open('https://www.randomdevelop.dev', '_blank');
    }, 600);
  };
      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              We are Press Start<br className="hidden sm:inline" />Your Partners to Success
            </h1>
            ...
            >
              Purpose-driven HR training for emerging leaders and modern teams.
            </p>
            ...
            >
              <a
                href="#contact"
                className="button-primary flex items-center justify-center w-full sm:w-auto text-center"
              >
          ...
          <div className="w-full lg:w-1/2 relative mt-6 lg:mt-0">
            {lottieData ? (
              ...
              <div className="relative">
                {/* Hero Image with Pop Animation */}
                <div className="absolute inset-0 bg-dark-900 rounded-2xl sm:rounded-3xl -z-10 shadow-xl"></div>
                <div
                  className={cn(
                    "relative overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl cursor-pointer",
                    "transform-gpu transition-all duration-300 ease-out",
                    isPopping && "scale-110 rotate-3"
                  )}
